...
########################################################
# Модуль base.py - системные утилиты сборки ONLYOFFICE #
# Python 3.5. Кроссплатформенные функции для работы с  #
# файлами, процессами, Git, Qt и окружением. Основной  #
# инструмент инфраструктуры сборки проекта.            #
#                                                      #
# Импортируется:                                       #
# • build_3rdparty.py - сборка зависимостей            #
# • qmake.py - сборка Qt-проектов                      #
# • automate.py - автоматизация сборки                 #
# • модули в /modules/ - для конкретных библиотек      #
# • config.py - конфигурация сборки                    #
########################################################
