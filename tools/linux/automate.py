...
print("=" * 60)
print("PAUSE - Press Enter to continue to make.py")
print("=" * 60)
print("You can now patch files in the container.")
print("Run in another terminal: docker exec -it CONTAINER_ID bash")
input()
