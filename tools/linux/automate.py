...
if not base.is_file("./node_js_setup_14.x"):
    ...
    pass#print("Зависимости уже установлены. Пропускаем установку.")

# =============================================================================
# ЭТАП 2: УСТАНОВКА QT
# =============================================================================

wait_for_continue("============== QT")
print("==============================")
...
if not base.is_dir("./qt_build"):
    ...
    pass#print("Qt уже установлен. Пропускаем установку.")

# =============================================================================
# ЭТАП 3: ОПРЕДЕЛЕНИЕ ВЕТКИ GIT
# =============================================================================

wait_for_continue("==================== GIT")
...
wait_for_continue("==========================")
pass #print("Анализируем переданные аргументы командной строки...")
...
#print("\n" + "="*80)
print(red_text("DONEEEEEEEEEEEEEEEEEE!"))
#print("="*80)
